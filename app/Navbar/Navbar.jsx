...
export default function Navbar() {
  ...
  return (
    ...
    <nav className="navbar fixed-top navbar-expand-md navbar-light bg-body bg-opacity-75 py-0 g ">
            ...
            <Link  href="/">
            <Image className={`${style.logos}   mx-3`} src={logo} width={200} height={100} alt="HACCP" />
            </Link>
            </div>
           ...
           <div className={`flex-wrap w-100   ${style.navround} `}>
            ...
            <div className={`${style.logoSub} col-md-3  justify-content-center `}>
             <Link href='/'>
                <Image src={logoW} width={120} height={60} alt='ff'/>
              </Link>
             </div>
            
            <button className={`${style.secBg} navbar-toggler border rounded-0 border-3 border-white d-lg-none`} type="button" data-bs-toggle="collapse" data-bs-target="#collapsibleNavId" aria-controls="collapsibleNavId"
              aria-expanded="false" aria-label="Toggle navigation">
              <span ><i class="fa-solid fa-bars text-white"></i></span>
            </button>
            
             <div className={`${style.navround } ${style.social} ms-auto d-flex col-md-9 `}>
             
             <div className={`${style.socialround} social w-75 bg-white align-items-center py-2 d-flex justify-content-around`}>
             ...
             <div className={`${style.socicon} login mx-auto align-items-center d-flex`}>
           ...
           <div className="collapse py-2 navbar-collapse   " id="collapsibleNavId">
              ...
              {links.map((link)=><li className="nav-item ">
                  <Link className={pathName===link.path? ` nav-link ${style.activLink} text-info text-bold `:`nav-link text-white`} href={link.path}>{link.link}</Link>
                </li>)}
