...
export default function CourseManager() {
  ...
  const handleSaveCourse = () => {
    ...
    if (!image || !introVideo || !title || !description || !duration || !price) {
  ...
  return (
    <div className="container py-4">
      <h3> Manage Courses & Groups</h3>
      <Button variant="primary" onClick={openAddCourseModal} className={`${styles.addCourseBtn} my-2`}>
        Add New Course
      </Button>
      ...
      {courses.map((c) => {
        ...
        return (
          <div key={c.id} className="my-4 p-3 border rounded">
            <CourseCard
              {...c}
              viewMode="list"
              adminMode
              onEdit={() => openEditCourseModal(c.id)}
                  ...
                  return (
                    ...
                    >
                      <div>
                        ...
                        {instructor?.name || "N/A"} | <strong>Start:</strong>{" "}
                        {g.startDate} | <strong>End:</strong> {g.endDate} |{" "}
          ...
          <Form>
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control
                ...
                onChange={(e) => setCourse({ ...course, introVideo: e.target.value })}
              />
            </Form.Group>
  ...
  <Modal.Header closeButton>
    <Modal.Title>{isEditingGroup ? "Edit Group" : "Add New Group"}</Modal.Title>
  </Modal.Header>
  <Modal.Body>
    <Form>
      <Form.Group className="mb-3">
